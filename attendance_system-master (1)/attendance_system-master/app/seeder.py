...
def seed_students(session: Session):
    students = [
        Student(name="Ahmed Ali", phone_number="01012345678", grade=3, faculty_id=1, seq_number=1,
                is_male=True, national_id="12345678901234", notes=""),
        Student(name="Sara Mohamed", phone_number="01098765432", grade=2, faculty_id=2, seq_number=2,
                is_male=False, national_id="98765432109876", notes=""),
        Student(name="Mohamed Khaled", phone_number="01111222333", grade=1, faculty_id=3, seq_number=3,
                is_male=True, national_id="11223344556677", notes=""),
    ]
